...
class _AddPostScreenState extends State<AddPostScreen> {
  ...
  Future<void> _generateDescriptionWithAI() async {
    ...
    try {
      ...
      const apiKey =
          'AIzaSyA6k9EjS-LT59yWpCxCTHkB8KrgH_k5Lgk'; // Ganti dengan API key kamu
      const url =
        ...
        "contents": [
          {
            "parts": [
              ...
              {
                "text": "Berdasarkan foto ini, identifikasi satu kategori utama kerusakan fasilitas umum dari daftar berikut: "
                    "Jalan Rusak, Marka Pudar, Lampu Mati, Trotoar Rusak, Rambu Rusak, Jembatan Rusak, Sampah Menumpuk, "
                    "Saluran Tersumbat, Sungai Tercemar, Sampah Sungai, Pohon Tumbang, Taman Rusak, Fasilitas Rusak, "
                    "Pipa Bocor, Vandalisme, Banjir, dan Lainnya. "
  ...
  Future<void> _getLocation() async {
    try {
      ...
      final position = await Geolocator.getCurrentPosition(
        desiredAccuracy: LocationAccuracy.high, // Tentukan tingkat akurasi
      ).timeout(const Duration(seconds: 10));

      // Menyimpan hasil lokasi
      setState(() {
